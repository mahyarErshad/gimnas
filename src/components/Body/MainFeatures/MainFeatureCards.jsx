...
function MainFeatureCards(props) {
  return (
    <div className="shadow-md h-[10.75rem] main-feature-card bg-white transition-all duration-500 rounded-[5px] p-6 flex-full-center flex-col text-center max-md:w-[45%] md:w-[23%] hover:bg-primary hover:text-white">
