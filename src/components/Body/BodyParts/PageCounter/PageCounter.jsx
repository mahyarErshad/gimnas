...
function PageCounter() {
  ...
  return (
    <section id="page-counter" className="bg-white relative z-10 py-[5.625rem] flex justify-center items-center flex-wrap max-md:px-4 md:px-8 lg:px-[15%] max-lg:gap-20">
      ...
      <PageCounterComponent number={12} text="تعداد صفحات اصلی" />
      <PageCounterComponent number={6} text="صفحات اصلی چندگانه" />
      <PageCounterComponent number={6} text="صفحات اصلی تکی" />
      <PageCounterComponent plus number={46} text="صفحات داخلی" />
    </section>
  );
}
