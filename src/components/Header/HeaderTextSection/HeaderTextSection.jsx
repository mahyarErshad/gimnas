...
function HeaderTextSection() {
  ...
  return (
    <div onMouseMove={animatedCircles} className="text-white w-full h-full flex justify-start flex-col items-center max-lg:gap-6 lg:gap-8 max-lg:pt-16 lg:pt-36">
      <HeaderTexts />
