...
function HeaderTextSection() {
  ...
  return (
    <div id="HeaderTextSection" onMouseMove={animatedCircles} className="text-white w-full h-full overflow-hidden flex justify-start flex-col items-center max-lg:gap-6 lg:gap-8">
      <HeaderTexts />
