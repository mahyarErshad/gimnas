...
function HeaderSliderButton(props) {
  return (
    <button className={`flex flex-nowrap items-center z-10 text-xl outline-none border-none w-[10.5rem] h-[3.125rem] absolute right-[-7.375rem] hover:opacity-90 ${props.top}`}>
