...
function HeaderSliderButton(props) {
  ...
  return (
    <button onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)} className={`flex flex-nowrap items-center z-10 text-xl outline-none border-none w-[10.5rem] h-[3.125rem] fixed ${right} hover:opacity-90 transition-all duration-500 ${props.top}`}>
