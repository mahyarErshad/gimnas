...
function InternalNavigationButton(props) {
  return (
    <a href={props.href || "#"} className="w-7 flex justify-center items-end h-14 border-[1px] rounded-[20px] absolute bottom-[5%] pb-1 transition-all hover:border-2 max-lg:hidden">
